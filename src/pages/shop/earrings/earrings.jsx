...
export default function Earrings() {
  ...
  const earringProducts = mockProducts.filter(product => product.category === 'earrings');
  const materials = ['White Gold', 'Yellow Gold', 'Rose Gold', 'Platinum', 'Diamond', 'Sapphire', 'Emerald', 'Pearls'];
  const styles = ['Stud', 'Drop', 'Hoop', 'Chandelier', 'Huggie', 'Threader'];

  const filteredProducts = useMemo(() => {
    let filtered = earringProducts.filter(product => {
    ...
    return filtered;
  }, [searchQuery, priceRange, selectedMaterials, selectedStyles, sortBy, earringProducts]);
        ...
        <div className="mb-8 animate-fade-in">
          <nav className="mb-4">
            <div className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <span>/</span>
              <span className="text-gray-900">Earrings</span>
            </div>
          </nav>
          ...
          <p className="text-lg text-gray-600">
            Explore our beautiful collection of {earringProducts.length} earrings, from delicate studs to dramatic drops.
          </p>
        </div>
          ...
          <div className={`lg:w-80 space-y-6 ${showFilters ? 'block' : 'hidden lg:block'}`}>
            <Card>
              <CardContent className="p-6 space-y-6">
                ...
                {/* Styles */}
                <div>
                  <h3 className="font-semibold text-lg mb-4">Styles</h3>
          ...
          <div className="flex-1">
            <div className="mb-6">
              <p className="text-gray-600">
                Showing {filteredProducts.length} of {earringProducts.length} earrings
              </p>
            </div>
